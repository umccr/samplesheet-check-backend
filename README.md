...
## Running SS Check via the remote API
...
## Testing SS Check Script locally

Some unit tests are placed in the respective test folder. Alternatively, this section will give a tutorial
